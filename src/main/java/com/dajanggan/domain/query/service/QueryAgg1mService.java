...
/**
 * 1분 집계 데이터 Service
 * - QueryOverview 및 ExecutionStatus 페이지 데이터 제공
        ...
        try {
            ...
            if (result == null) {
                ...
                result = QuerySummaryDto.builder()
                        ...
                        .updateCount(0)
                        .deleteCount(0)
                        .timeRange("최근 5분 평균 기준")
                        .build();
            } else {
                result.setTimeRange("최근 5분 평균 기준");
    ...
    public QueryOverviewTrendDto findTrendData(Long instanceId, Long databaseId, Integer hours) {
        ...
        try {
            ...
            if (rawData == null || rawData.isEmpty()) {
                log.warn("트렌드 데이터가 없습니다 - 빈 결과 반환");
