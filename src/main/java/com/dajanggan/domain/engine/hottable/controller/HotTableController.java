...
public class HotTableController {
    ...
    public ResponseEntity<HotTableDto.DashboardResponse> getHotTableDashboard(
        ...
        log.debug("HotTable 대시보드 조회 요청 - databaseId: {}", databaseId);

        HotTableDto.DashboardResponse response = hotTableService.getHotTableDashboard(databaseId);
    ...
    public ResponseEntity<HotTableDto.ListResponse> getHotTableList(
        ...
        log.debug("HotTable 리스트 조회 요청 - databaseId: {}, timeRange: {}, status: {}",
        ...
        HotTableDto.ListResponse response = hotTableService.getHotTableList(databaseId, timeRange, statusList);
