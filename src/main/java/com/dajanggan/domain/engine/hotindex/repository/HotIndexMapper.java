...
public interface HotIndexMapper {
     ...
     */
    Map<String, Object> selectUsageDistribution(@Param("databaseId") Long databaseId);
     ...
     */
    List<Map<String, Object>> selectTopUsageIndexes(@Param("databaseId") Long databaseId);
     ...
     */
    List<Map<String, Object>> selectInefficientIndexes(@Param("databaseId") Long databaseId);
     ...
     * @return 인덱스별 효율성 데이터
     */
    List<Map<String, Object>> selectIndexEfficiency(@Param("databaseId") Long databaseId);
